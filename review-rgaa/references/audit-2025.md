...
Sources : rapport « Audit RGAA 4.1 – DGEFP – 25/11/2025 » (Audit-Web, 147 p.) et sa grille de calcul (onglets Synthèse, BaseDeCalcul, Critères, P01–P27), non versionnés ; à demander à la mission apprentissage. Certaines corrections ont été livrées depuis : **toujours confronter un ticket au code actuel avant de le reporter comme ouvert.**
